 ...
 * random y-value.
 * The generated {@link com.event.app.activity.EventDaydreamServiceSettingsActivity} allows
 * the user to change the text which is displayed.
 * <p />
 * Daydreams are only available on devices running API v17+.
 */
@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
public class EventDaydreamService extends DreamService {
    ...
    public void onAttachedToWindow() {
        ...
        setContentView(R.layout.event_daydream);
